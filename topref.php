...
Description: Automatic top referral tracking script. Displays top referrers with hits in/out and several other stats. Fully customizable.
...
function toprefs_menu_options(){
	...
	<tr>
	<td><b>Ban Time:</b></td>
	<td><input type="text" name="topref_bantime" value="'.get_option('topref_ban_time').'" /></td>
	<td>Number of minutes to ban another referral from the IP & URL</td>
	</tr>
	<tr>
	<td><b>Track For X Days:</b></td>
	<td><input type="text" name="topref_numdays" value="'.get_option('topref_number_of_days').'" /></td>
